...
export default function FormCrearUsuarios({ onRegistrationSuccess }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      deporte: Yup.string().required("El deporte es obligatorio"),
      posicion: Yup.string().required("La posición/rol es obligatoria"),
      club: Yup.string().required("El club es obligatorio"),
      secretPassword: Yup.string().when("role", {
        is: "coach",
        then: (schema) =>
          schema.required("La clave de administrador es obligatoria"),
        ...
        <S.Form onSubmit={formik.handleSubmit}>
          ...
          <S.GridTwo>
            <div>
              ...
              {formik.touched.email && formik.errors.email && (
                <S.ErrorBox>{formik.errors.email}</S.ErrorBox>
              )}
            </div>
            ...
            <div>
              ...
              {formik.touched.password && formik.errors.password && (
                <S.ErrorBox>{formik.errors.password}</S.ErrorBox>
              )}
            </div>
          </S.GridTwo>
          ...
          <S.GridThree>
            <div>
              ...
              {formik.touched.nombre && formik.errors.nombre && (
                <S.ErrorBox>{formik.errors.nombre}</S.ErrorBox>
              )}
            </div>
            ...
            <div>
              ...
              {formik.touched.apellido && formik.errors.apellido && (
                <S.ErrorBox>{formik.errors.apellido}</S.ErrorBox>
              )}
            </div>
            ...
            <div>
              ...
              {formik.touched.role && formik.errors.role && (
                <S.ErrorBox>{formik.errors.role}</S.ErrorBox>
              )}
            </div>
          </S.GridThree>
          ...
          <S.Spacer>
            ...
            {formik.touched.dni && formik.errors.dni && (
              <S.ErrorBox>{formik.errors.dni}</S.ErrorBox>
            )}
          </S.Spacer>
          ...
          {formik.values.role === "coach" && (
            <S.Spacer>
              ...
              <S.Input
                ...
                onBlur={formik.handleBlur}
              />
              {formik.touched.secretPassword &&
                formik.errors.secretPassword && (
                  <S.ErrorBox>{formik.errors.secretPassword}</S.ErrorBox>
                )}
            </S.Spacer>
          )}
          ...
          <S.GridThree>
            ...
            <div>
              ...
              >
                ...
                {getPositionsForSport(formik.values.deporte).length === 0 ? (
                  <option value={formik.values.posicion || ""}>
                    {formik.values.posicion || "Otra"}
                  </option>
                ) : (
              ...
              {formik.touched.posicion && formik.errors.posicion && (
                <S.ErrorBox>{formik.errors.posicion}</S.ErrorBox>
              )}
            </div>
            ...
            <div>
              ...
              {formik.touched.club && formik.errors.club && (
                <S.ErrorBox>{formik.errors.club}</S.ErrorBox>
              )}
            </div>
          </S.GridThree>
          ...
          {exito && (
            <S.SuccessMessage>
              ¡Tu cuenta se registró exitosamente!
            </S.SuccessMessage>
          )}
