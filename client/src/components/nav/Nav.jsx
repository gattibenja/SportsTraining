        ...
        <S.ActionsContainer>
          {isAuthenticated ? (
            <S.UserMenuContainer>
              ...
              <S.DropdownMenu>
                <S.DropdownUserName>
                  Cuenta de {user?.nombre || "Usuario"}
                </S.DropdownUserName>
                {isCoach ? (
                  <S.DropdownItem to="/admin/users">Usuarios</S.DropdownItem>
                ) : null}
                {isCoach ? (
                  <S.DropdownItem to="/admin/dashboard">
                    Dashboard
                  </S.DropdownItem>
                ) : null}
                {isAthlete ? (
                  <S.DropdownItem to="/athlete/profile">
                    Completar Perfil
                  </S.DropdownItem>
                ) : null}
                {isAthlete ? (
                  <S.DropdownItem to="/athlete/trainings">
                    Entrenamientos
                  </S.DropdownItem>
                ) : null}
                {isAthlete ? (
                  <S.DropdownItem to="/athlete/dashboard">
                    Mi Dashboard
                  </S.DropdownItem>
                ) : null}
                <S.DropdownItem onClick={logout}>Salir</S.DropdownItem>
              </S.DropdownMenu>
            </S.UserMenuContainer>
          ) : (
            <S.Links
