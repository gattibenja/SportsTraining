...
export const logo = styled.div`
  ...
  &:hover {
    box-shadow: 0 0 10px 5px rgba(189, 189, 189); /* 0 X, 0 Y, 20px blur, 5px spread, negro translúcido */
  }
`;
export const Lista = styled.ul`
  ...
  @media (max-width: 992px) {
    ...
    border-top: ${(props) =>
      props.open ? "1px solid var(--border)" : "0px solid transparent"};
    box-shadow: ${(props) =>
      props.open ? "0 8px 16px rgba(0, 0, 0, 0.2)" : "none"};
