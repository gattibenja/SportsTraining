...
function AthleteProfile() {
  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        frecuenciaDeCompetencia: user.frecuenciaDeCompetencia
          ? user.frecuenciaDeCompetencia.split("T")[0]
          : "",
  ...
  return (
    <div style={styles.container}>
      <h2 className="text-white font-black py-7">Completar Perfil de Atleta</h2>
      <form onSubmit={handleSubmit}>
          ...
          <div style={styles.col}>
            ...
            >
              ...
              {getPositionsForSport(formData.deporte).length === 0 ? (
                <option value={formData.posicion || ""}>
                  {formData.posicion || "Otra"}
                </option>
              ) : (
        ...
        <div style={styles.row}>
          <div style={styles.col}>
            ...
            <select
              name="objetivosAtleta"
              value={formData.objetivosAtleta}
              onChange={handleChange}
              style={styles.input}
            >
              ...
              <option value="prevencion lesiones">
                Prevención de lesiones
              </option>
              <option value="recomposicion corporal">
          ...
          <div style={styles.col}>
            ...
            <input
              ...
              onChange={handleChange}
              style={styles.input}
              placeholder="Ej: Activo, En recuperación..."
            />
          </div>
        </div>
        ...
        <div style={styles.row}>
          <div style={styles.col}>
            ...
            <input
              type="text"
              name="diasDisponiblesGimnasio"
              value={formData.diasDisponiblesGimnasio}
              onChange={handleChange}
              style={styles.input}
          ...
          <div style={styles.col}>
            ...
            <input
              type="text"
              name="diasPracticaDeporte"
              value={formData.diasPracticaDeporte}
              onChange={handleChange}
              style={styles.input}
          ...
          <div style={styles.col}>
            ...
            <input
              type="date"
              name="frecuenciaDeCompetencia"
              value={formData.frecuenciaDeCompetencia}
              onChange={handleChange}
              style={styles.input}
            />
          </div>
        ...
        <div style={styles.formGroup}>
          ...
          <textarea
            ...
            placeholder="Describe tus lesiones previas o actuales..."
          ></textarea>
        </div>
