...
function Dashboard() {
  ...
  if (loading)
    return <div className="app-container">Cargando dashboard...</div>;
  ...
  const avgRPE = trainingsCount
    ? (
        trainings.reduce((s, t) => s + (t.rpe || 0), 0) / trainingsCount
      ).toFixed(1)
    : "—";
    ...
    <>
      <div className="app-container">
        ...
        <section className="card">
          ...
          <p className="muted">
            Bienvenido a CASST. Aquí puedes gestionar entrenamientos, atletas y
