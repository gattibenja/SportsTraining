...
function RegisterTrainings() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!payload.casstAu && payload.duracion && payload.rpe) {
        payload.casstAu = payload.duracion * payload.rpe;
      }
      ...
      if (!res.ok) {
        ...
        throw new Error(
          (resBody && (resBody.error?.message || resBody.message)) ||
  ...
  return (
    <>
      <S.Main className="container">
        <S.PageHeader className="flex flex-col lg:flex-col gap-5 mt-10">
          <h2 className="text-white ">Mis entrenamientos</h2>
          <button
            ...
            <S.FormGrid onSubmit={handleSubmit}>
              ...
              <S.Row>
                ...
                <S.FieldLabel flex={1}>
                  Trabajo principal
                  <select
                    name="trabajoPrincipal"
                    value={form.trabajoPrincipal}
                    onChange={handleChange}
                  >
                    ...
                    <option value="movilidad/flexibilidad">
              ...
              <S.FieldLabel row center gap={8}>
                <input
                  ...
                  type="checkbox"
                  checked={form.cumplimientoObjetivo}
                  onChange={handleChange}
                />{" "}
                Cumplí el objetivo de entrenamiento
              </S.FieldLabel>
